      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center">
          ...
          <p className="text-3xl py-6 text-slate-500">
            ...
            obcaecati accusamus veniam accusantium enim porro magnam vel iusto,
            maxime aperiam maiores earum, mollitia, praesentium facere odio eum?
            Vitae, sapiente.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-1 px-2 text-center">
          <div className="border py-8 rounded-xl shadow-xl">
            ...
            <p className="text-slate-400 mt-2">Completion</p>
          </div>
          <div className="border py-8 rounded-xl shadow-xl">
          ...
          <div className="border py-8 rounded-xl shadow-xl">
            ...
            <p className="text-slate-400 mt-2">Transactions</p>
          </div>
        </div>
      </div>
    </div>

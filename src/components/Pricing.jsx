...
const Pricing = () => (
  <div name="pricing" className="w-full text-white my-24">
    ...
    <div className="m-w-[1240px] mx-auto py-12">
      <div className="text-center py-8 text-slate-300">
        ...
        <p className="text-3xl">
          ...
          illo reiciendis ducimus ad dolores dignissimos officiis earum maiores
          quisquam!
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2">
        <div className="bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative">
          ...
          <div>
            ...
            <button className="w-full py-4 my-4 bg-black hover:bg-black text-white hover:text-white">
              Get Standard
            </button>
          </div>
        </div>
